          ...
          <div className="mb-6 md:mb-8">
            ...
            <div className="bg-gradient-to-r from-[#5C2C1D]/10 to-[#7A3726]/5 rounded-xl md:rounded-2xl p-4 md:p-6 mb-6 md:mb-8 mx-2">
              <p className="text-base md:text-lg lg:text-xl text-gray-700 leading-relaxed">
                Nossa equipe entrará em contato <strong>em até 24 horas</strong> para transformar seu ambiente com a sofisticação Ateneo.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 mb-8 md:mb-10">
            <div className="text-center p-4 md:p-6">
              <div className="w-12 h-12 md:w-16 md:h-16 bg-[#5C2C1D]/10 rounded-xl md:rounded-2xl mx-auto mb-3 md:mb-4 flex items-center justify-center">
                <svg className="w-6 h-6 md:w-8 md:h-8 text-[#5C2C1D]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
              </div>
              <h3 className="text-sm md:text-base font-medium text-gray-900 mb-1 md:mb-2">1. Ligação</h3>
              <p className="text-xs md:text-sm text-gray-600">Nossa equipe entrará em contato</p>
            </div>
            ...
            <div className="text-center p-4 md:p-6">
              ...
              <h3 className="text-sm md:text-base font-medium text-gray-900 mb-1 md:mb-2">2. Consulta</h3>
              <p className="text-xs md:text-sm text-gray-600">Análise do seu espaço e necessidades</p>
            </div>
            ...
            <div className="text-center p-4 md:p-6">
              ...
              <h3 className="text-sm md:text-base font-medium text-gray-900 mb-1 md:mb-2">3. Projeto</h3>
              <p className="text-xs md:text-sm text-gray-600">Desenvolvimento da proposta ideal</p>
            </div>
          </div>
